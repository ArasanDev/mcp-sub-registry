...
Production reference for the MCP Sub-Registry. Operating identity and the session loop live
in the root [`CLAUDE.md`](../CLAUDE.md); these docs are the deep references it points to.

| Doc | What it covers |
| --- | --- |
| [GATEWAY_CONTRACT.md](./GATEWAY_CONTRACT.md) | The boundary and the `/v0.1/gateway/catalog` projection contract — the keystone |
| [API.md](./API.md) | Full public + admin API contract |
