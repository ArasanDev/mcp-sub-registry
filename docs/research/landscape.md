...
- **Latest daily update:** [2026-08-18-mcp-ecosystem-update.md](./2026-08-18-mcp-ecosystem-update.md)
- **Last updated:** 2026-08-18 (daily research pass — **Glama ~73,090 (+614 vs. Aug 17)**; MCPToplist 100,958 (Aug 10 snap; 8 days stale); **PulseMCP ~22,050+ (flat, Day 8 — ingestion rework pause now 8 days past "mid-August" deadline)**; **AAIF Seoul blog recap STILL NOT PUBLISHED** (Day 4 post-summit; Futurumgroup analyst coverage: "disciplined guardrails" theme); **MCPwned BH2026 slides still not public** (GitHub release loading error; BH archive expected Aug 19–20 — tomorrow); **Azure DevOps Remote MCP Server GA (Aug 5)** — confirmed org-specific endpoint `mcp.dev.azure.com/{org}` + Entra auth; not universally catalogable; watch list maintained; **CVE-2026-10591** (Kiro IDE CVSS 8.8/8.6, patched v0.11.130) — prompt injection rewrites mcp.json via hidden web text; client-side only; no catalog action; reinforces our stable URL guarantee; **Adversa AI: three August 2026 digests live** (MCP security, AI Coding Agent, Agentic AI); **SEP-2127 server card audit OVERDUE** (WG closed Aug 14; `subregistry-audit` highest priority); security Day 53 clean)
