...
| 2 | **JFrog MCP Registry** | Enterprise registry | Part of JFrog supply-chain suite | Curated internal catalog, RBAC, audit, allowlist | **Closest analogue** — benchmark |
| 3 | **Obot** | Gateway + catalog | OSS (MIT) | **Clean** discovery→approval→runtime, IT-verified trust | Best model-match; study its split |
...
| 8 | **Smithery** | Directory + hosting | ~2,500–7,000 (sources vary) | No formal governance; prototyping-grade | Discovery breadth, not a trust layer |
...
**Honorable mentions / watch list:** mcp.so (~19k, unvetted), MCP Market (~10k, community),
