...
- **Latest daily update:** [2026-08-17-mcp-ecosystem-update.md](./2026-08-17-mcp-ecosystem-update.md)
- **Last updated:** 2026-08-17 (daily research pass — **Glama ~72,476 (+148; search index cache)**; MCPToplist 100,958 (Aug 10 snap; no new snapshot; 7 days stale); **PulseMCP ~22,050+ (flat, Day 7 — "until mid-August" pause now 7 days past deadline; step-jump still pending)**; **AAIF Seoul blog recap STILL NOT PUBLISHED** (Day 3 post-summit; Forkast framing: Seoul was "a high-stakes confrontation around security issues"); **MCPwned BH2026 slides still not public** (GitHub onhexgroup/Conferences bhusa2026 release exists but content fails to load; BH archive expected ~Aug 19–20; T-2 days; no cataloged vendor named); **Getty Images MCP Server launched Aug 12** — first major visual-content platform; enterprise licensing-gated; media/creative persona watch list; **Fenrisk MCPwned Burp Suite extension** confirmed in BApp Store (separate from BH2026 briefing — pentest tool for auditing MCP endpoints); **Official MCP Registry ~2,000 entries, v0.1 frozen, v1 GA no date set**; **SEP-2127 server card audit OVERDUE** (WG closed Aug 14; `subregistry-audit` trigger active); security Day 52 clean)
...
| 3 | **Runlayer** | Enterprise gateway + catalog | **$42M total** (**$30M Series A, June 24, 2026**, led by Felicis/Khosla); customers include Instacart, Gusto, Decagon, Opendoor, dbt Labs, AngelList, Lemonade + Fortune 500s; 18,000+ server catalog; **AAIF founding member** (alongside Anthropic, OpenAI, Google — confirmed July 2026); **AARM Extended Conformance (R1–R9)** achieved April 2026 (one of only 3 companies: Runlayer, Noma Security, Formal); **1Password integration** — secret injection via `op://` vault references (replaces plaintext .env); at Black Hat USA 2026 (Aug 1–6) with executive briefings | Security-approved servers, ABAC, conditional access, SCIM, audit; `discovered != approved != enabled` enforced; MCP Apps extension supported from day 1 by existing governance layer | **Top-tier** — largest pure-play enterprise MCP governance funding; architecture exactly matches our boundary discipline; now in governance co-authorship position via AAIF; AARM conformance is a fourth external framework validating our boundary discipline |
...
**Snowflake Cortex AI Gateway** (formally launched at Black Hat USA 2026, Aug 2026; announced July 28 alongside 2026-07-28 spec; **entering public preview imminently** — no GA date set; built on Natoma acquisition closed ~June 2026; Natoma: $7M seed/Greylock+Index Ventures, 27-person team, CEO Pratyus Patnaik ex-atSpoke/Okta; Cortex AI Gateway integrates identity, policy, and audit at the tool-call level; supports 100+ MCP servers; governs Snowflake-native agents AND third-party agents on Claude Code + Cursor; 7 launch identity partners: 1Password, Aembit, Linx Security, Okta, SailPoint, Saviynt; cost management: per-team/agent/workload AI spend attribution + limits; **sixth major enterprise player to independently converge on `discovered != approved != enabled`**; gateway/runtime product — consumes clean catalog data, does not replace a curated registry function; [[Snowflake BH2026 blog]](https://www.snowflake.com/en/blog/enterprise-ai-security-agentic-mcp-governance/) [[VentureBeat]](https://venturebeat.com/security/snowflake-launches-cortex-ai-gateway-to-control-ai-agents-and-prevent-runaway-enterprise-costs/) [[Forkast: MCP gateways crystallizing as infra]](https://forkast.news/snowflakes-cortex-ai-gateway-signals-mcp-gateways-are-crystallizing-as-infrastructure)),
...
**Microsoft Dynamics 365 Customer Service MCP Server** (**GA July 30, 2026** [[blog]](https://www.microsoft.com/en-us/dynamics-365/blog/it-professional/2026/07/30/dynamics-365-customer-service-mcp-server-ga/); enables MCP-compatible AI clients to access service data, knowledge bases, cases, and workflows; governance controls published Aug 5 [[blog]](https://www.microsoft.com/en-us/dynamics-365/blog/it-professional/2026/08/05/governance-customer-service/); per-tenant org URL — not catalogable; Microsoft's enterprise MCP footprint now spans four distinct catalog products: Entra ID (Preview), Dataverse, D365 Customer Service, D365 ERP),
**Microsoft Dynamics 365 Sales MCP Data Partners** (announced July 21, 2026; 7 MCP server integrations from ZoomInfo, Dun & Bradstreet, LeadIQ, Draup, Gong, Enlyft, HG Insights — each delivers sales intelligence data into D365 Sales via MCP; [[Microsoft blog]](https://www.microsoft.com/en-us/dynamics-365/blog/business-leader/2026/07/21/extending-agentic-microsoft-dynamics-365-sales-with-mcp/); per-tenant/partner URLs, not catalogable; documents the enterprise application-data MCP wrapping pattern at Microsoft scale — same pattern as Salesforce Agentforce 3),
...
**Nutanix MCP Server for NCP** (announced Aug 10, 2026; open-source MCP server for Nutanix Cloud Platform via Prism v4 API; supports Claude Code, GitHub Copilot, Cursor; translates plain-English to infrastructure API calls; per-environment deployment — not catalogable as universal endpoint; signals seventh major infrastructure vendor shipping an official MCP server; infrastructure-management persona watch list; [[GlobeNewswire]](https://www.globenewswire.com/news-release/2026/08/10/3341875/0/en/nutanix-puts-agentic-ai-into-action-for-enterprises.html)),
**Team Cymru Pure Signal MCP Server** (launched April 29, 2026; first purpose-built production-grade MCP server for threat intelligence — connects Claude, Microsoft Security Copilot, Copilot Studio, GitHub Copilot and custom agents to Team Cymru's Pure Signal platform "the world's largest threat intelligence data ocean"; subscription-gated, security persona — not a developer-tools catalog candidate; relevant to §12.5 security-persona bundle; [[BusinessWire]](https://www.businesswire.com/news/home/20260429970778/en/Team-Cymru-Launches-Pure-Signal-MCP-Server-Bringing-Agentic-AI-to-the-Worlds-Largest-Threat-Intelligence-Data-Ocean)),
**Getty Images MCP Server** (launched Aug 12, 2026; first major visual-content platform to ship an official MCP server; tools: image/video search, content download; enterprise/licensing-gated; official docs: `gettyimages.com/ai/mcp`; not a current developer-tools catalog candidate — relevant to §12.5 media/creative persona bundle; endpoint URL + auth model to verify in next media-persona curate cycle; [[GlobeNewswire]](https://www.globenewswire.com/news-release/2026/08/12/3344005/0/en/getty-images-launches-mcp-server-to-connect-creative-and-editorial-content-to-ai-workflows-and-products.html)).
...
- **Scale signal (Aug 3, 2026):** Cross-registry ecosystem count updated: **~96,771**
  ...
  **Privacy leakage (July 2026):** "What Happens Locally, Leaks Globally" (arxiv:2606.21338)
  analyzed 10,655 MCP servers: 12.4% have confirmed privacy leakage risks; credentials
  are 56.22% of leaked entities; Glama has the lowest leakage rate (8.8%) among registries
  studied. Our schema stores secret *names* only — structurally immune to the documented
  leakage pattern.
...
- **Spec watch:** MCP 2026-07-28 RC (locked May 21; ships July 28 — **18 days**). SDK v2 betas live June 29 (Python mcp==2.0.0b1; TS v2 beta.2 July 2; Go v1.7.0-pre.1; C# v2.0.0-preview.1); Python stable July 27; TS stable July 28. Breaking changes:
...
- **Ads-platform MCP pattern (April–June 2026):** Google (Apr 28), Meta (Apr 29), TikTok (May 13), and
  X/Twitter (June 30) all shipped official hosted MCP servers for their platforms. Pattern: platforms now
  ship vendor-blessed MCP endpoints rather than leaving integration to community servers. Relevant to
  §12.5 persona-based catalog expansion: a "performance marketer" persona would add Meta Ads, Google Ads,
  TikTok Ads, and X MCP servers as a curated bundle. **X MCP Server** is a catalog candidate pending
  endpoint/auth verification. [[TechCrunch]](https://techcrunch.com/2026/06/30/x-now-offers-an-mcp-server-to-make-its-platform-easier-for-ai-tools-to-use/)
- **MCP security certification (June 2026):** Practical DevSecOps launched **CMCPSE** (Certified MCP
  Security Expert) on June 15, 2026 — the first hands-on MCP security certification. Covers OWASP MCP
  Top 10, tool poisoning, OAuth 2.1, supply chain security; 6-hour exam; $599. Signals practitioner-level
  demand for MCP security expertise. CMCPSE curriculum teaches `discovered != approved != enabled` as the
  foundational control model. [[Practical DevSecOps]](https://www.practical-devsecops.com/certified-mcp-security-expert/)
- **Claude Code MCP reliability (July 2, 2026 — v2.1.199):** 5-minute idle timeout for hanging remote tool
  calls; OAuth `invalid_scope` fix for enterprise IdPs (affects GitLab self-hosted and similar); capability
  discovery retry on transient errors; headless OAuth flow; better 404 diagnostics. Enterprise operators
  on cataloged OAuth-gated servers should update Claude Code and re-auth if they hit `invalid_scope` failures.
  [[Claude Code changelog]](https://code.claude.com/docs/en/changelog)
- **ToolHive skills layer (2026):** Stacklok ToolHive now ships **agent skills** — reusable instruction
  bundles published to a registry and installed across AI clients from a single CLI. Adds a skill-catalog
  layer on top of the MCP server catalog. vMCP adds circuit breakers for cascading failure prevention;
  Registry Server gains multi-tenant Kubernetes namespace scanning. Validates the §12.5 direction of
  persona-based bundles as the next product layer. [[ToolHive]](https://github.com/stacklok/toolhive)
