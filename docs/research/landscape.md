...
- **Latest daily update:** [2026-08-24-mcp-ecosystem-update.md](./2026-08-24-mcp-ecosystem-update.md)
- **Last updated:** 2026-08-24 (daily research pass — **Glama ~76,832 (+505; approaching 77k)**; **MCPToplist 108,245 (Aug 23 snap; NEW — crosses 108k, up from 100,958 Aug 10 snap; +7,287 in 13 days)**; **PulseMCP ~22,020–22,050 (flat, Day 14 — ingestion-rework pause now 14 days overdue; step-jump still pending)**; **AAIF Seoul blog recap STILL NOT PUBLISHED** (Day 10 post-summit; Futurumgroup + Forkast third-party coverage surfaced); **MCPCon Shanghai in 13 days** (Sept 6–7; KubeCon China co-located; sessions will be recorded); **SEP-2127 server card audit OVERDUE** (follow-on WG meetings Aug 31 + Sep 7; `subregistry-audit` highest priority); security Day 59 clean)
