...
- **Latest daily update:** [2026-08-23-mcp-ecosystem-update.md](./2026-08-23-mcp-ecosystem-update.md)
- **Last updated:** 2026-08-23 (daily research pass — **Glama ~76,327 (+713; CROSSES 76k MILESTONE)**; MCPToplist 100,958 (Aug 10 snap; 13 days stale); **PulseMCP ~22,020–22,070 (flat, Day 13 — ingestion-rework pause now 13 days overdue; step-jump still pending)**; **AAIF Seoul blog recap STILL NOT PUBLISHED** (Day 9 post-summit; window extending beyond Aug 22–24 estimate); **Official MCP Roadmap blog post published Aug 22** — 5 priority areas for next spec: agentic messaging primitives, HTTP-native transport unification, agent identity + enterprise security (PoP/WIF/token-exchange), improved primitives (progressive discovery), improved SDK DX; **GitHub Copilot JetBrains + Eclipse MCP governance (Aug 18)** — `allowedMcpServers`/`deniedMcpServers` enterprise managed settings extended to JetBrains and Eclipse; third major IDE ecosystem enforcing URL-based MCP allowlists; **SEP-2127 server card audit OVERDUE** (PR still open; WG follow-on meetings Aug 31 + Sep 7; `subregistry-audit` highest priority); security Day 58 clean)
