...
**As of 2026-07-31 (daily research pass — spec post-release day 3; CVE-2026-66012 SiYuan CVSS 10; MCPCon Shanghai agenda live; Glama 65,354):**
...
- **Research:** landscape + top-11 ranking in `docs/research/`. Ranking updated 2026-07-31:
  scale numbers updated (Glama 65,354; PulseMCP ~22,110+; MCPToplist 81,852). Prior update 2026-07-30:
...
- **Next actions (ordered):**
  ...
  6. Once SEP-2127 (MCP Server Cards) WG finalizes (term ends Aug 14, 2026 — 14 days), extend
  ...
  7. AWS Agent Registry namespace migration: Aug 6 (6 days); our `com.aws/mcp` unaffected.
