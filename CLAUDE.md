...
**As of 2026-08-16 (daily research pass — Glama ~72,328 (approx. flat, egress-blocked; search index cache); MCPToplist 100,958 cross-registry (Aug 10 snap; no new snapshot); PulseMCP ~22,050+ (flat, Day 6 — "until mid-August" pause at stated end date; rework ship + step-jump imminent); AAIF Seoul blog recap STILL NOT PUBLISHED (Day 2 post-summit; 247 total orgs confirmed, 3G/33S/21A breakdown, Visa+Wells Fargo first financial-services Gold); MCPwned slides NOT YET PUBLIC (expected ~Aug 19–20; no cataloged vendor named); Claude Code v2.1.233 (Aug 14) MCP v2 serverless-host fix — infinite subscription stream reopening on timeout-enforcing infrastructure, fixed; SEP-2127 server card audit OVERDUE (WG closed Aug 14; `subregistry-audit` now highest priority); security Day 51 clean):**
