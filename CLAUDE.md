...
**As of 2026-08-17 (daily research pass — Glama ~72,476 (+148; search index cache); MCPToplist 100,958 cross-registry (Aug 10 snap; no new snapshot); PulseMCP ~22,050+ (flat, Day 7 — "until mid-August" pause now 7 days past stated end date; step-jump still pending); AAIF Seoul blog recap STILL NOT PUBLISHED (Day 3 post-summit; Forkast framing: "high-stakes confrontation around security issues"); MCPwned BH2026 slides NOT YET PUBLIC (GitHub release tag exists/content fails to load; BH archive expected ~Aug 19–20); Getty Images MCP Server launched Aug 12 (first visual-content platform; enterprise licensing-gated; media/creative persona watch list); Fenrisk MCPwned Burp Suite extension confirmed in BApp Store (separate pentest tool); Official MCP Registry ~2,000 entries v0.1 frozen v1 GA no date; SEP-2127 server card audit OVERDUE (WG closed Aug 14; `subregistry-audit` now highest priority); security Day 52 clean):**
