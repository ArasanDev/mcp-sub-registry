...
**As of 2026-08-18 (daily research pass — Glama ~73,090 (+614 vs. Aug 17 ~72,476); MCPToplist 100,958 cross-registry (Aug 10 snap; no new snapshot; 8 days stale); PulseMCP ~22,050+ (flat, Day 8 — "until mid-August" pause now 8 days past stated end date; step-jump still pending); AAIF Seoul blog recap STILL NOT PUBLISHED (Day 4 post-summit; Futurumgroup analyst coverage published: "disciplined guardrails" theme; no official aaif.io blog post); MCPwned BH2026 slides NOT YET PUBLIC (GitHub release loading error Aug 18; BH archive expected Aug 19–20 — tomorrow); Azure DevOps Remote MCP Server GA (Aug 5) confirmed org-specific endpoint only — not catalogable; CVE-2026-10591 (Kiro IDE CVSS 8.8/8.6; prompt injection rewrites mcp.json via hidden web text; client-side; no catalog action; reinforces URL stability guarantee); Adversa AI: three August 2026 digests now live; SEP-2127 server card audit OVERDUE (WG closed Aug 14; `subregistry-audit` highest priority); security Day 53 clean):**
